...
def main():
    ...
    if os.name == 'nt':
        os.system("title Femelles")
    else:
        print('Femelles AIO')

    print(f'''
{Fore.LIGHTRED_EX}
 _______  _______ .___  ___.  _______  __       __       _______     _______.        ___       __    ______   
|   ____||   ____||   \/   | |   ____||  |     |  |     |   ____|   /       |       /   \     |  |  /  __  \  
|  |__   |  |__   |  \  /  | |  |__   |  |     |  |     |  |__     |   (----`      /  ^  \    |  | |  |  |  | 
|   __|  |   __|  |  |\/|  | |   __|  |  |     |  |     |   __|     \   \         /  /_\  \   |  | |  |  |  | 
|  |     |  |____ |  |  |  | |  |____ |  `----.|  `----.|  |____.----)   |       /  _____  \  |  | |  `--'  | 
|__|     |_______||__|  |__| |_______||_______||_______||_______|_______/       /__/     \__\ |__|  \______/  
    ...
    time.sleep(1)
    slowprint(
        f'{Fore.LIGHTBLACK_EX}Made by: {Fore.RESET}{Fore.RED}Femelles{Fore.RESET}', .02)
    time.sleep(1)
